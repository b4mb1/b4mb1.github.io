(function ($) {
    ...
    /*-- Lang switcher --*/
     $("#plpick").click(function(e) {
        ...
        pl: {
          ...
          under_header: "Nie masz gotówki i nie możesz zostawić napiwku? Z aplikacją TipMe ten problem to przeszłość. Nagradzaj za wyśmienitą obsługę bez konieczności odwiedzenia bankomatu! Wkrótce dostępna na system iOS i Android!",
          about_page_title: "O TipMe",
          ...
          application_subtitle: "Wkrótce dostępna na system iOS i Android!",
    ...
    $("#enpick").click(function(e) {
        ...
        en: {
          ...
          fees_ans: "TipMe charges a small fee for the payment processing. The current fees can be found in the “Terms & Conditions” section of the app.",
