    ...
    /*-- Lang switcher --*/
     $("#plpick").click(function(e) {
        ...
        pl: {
          ...
          faq: "FAQ",
          contact: "Kontakt",
          header: "Zwiększ przychody z napiwków w Twoim lokalu!",
          under_header: "Prowadzisz Restaurację, Bar, Salon Beauty - to rozwiązanie właśnie dla Ciebie! Zintegruj się już dziś z aplikacją SERVAL całkowicie za darmo!",
          ...
          application_subtitle: "Dla właścicieli lokali",
          feat1_subtitle: "kłopot z rozdzielaniem napiwków? W naszej aplikacji napiwki trafiają automatycznie na konto kelnera i nie wymagają dodatkowej pracy integracja nic nie kosztuje Razem z napiwkiem użytkownik może zostawić komentarz, do którego dostęp będziesz mieć w dashboardzie",
